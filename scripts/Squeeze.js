  ...
  */
  ns.Chunking = function () {
    ...
    */
    ...
    /**
    * whether to make digest to avoid rewriting unchanged records
    * @return {boolean} respectDigest the max size
    */
    self.getMakeDigest = function () {
      return makeDigest_;
    };
    ...
    * @return {Chunking} self
    */
    self.setMakeDigest = function (makeDigest) {
      makeDigest_ = makeDigest;
      return self;
    };
    ...
    */
    function setBigProperty_ (propKey,ob) {
      ...
      var digest = makeDigest_ ? "-" : digest_ (sob) ;
